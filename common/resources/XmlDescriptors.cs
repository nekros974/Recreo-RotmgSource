...
namespace common.resources
{
    ...
    //public class ConditionEffect mattt
    //{
    ...
    public class Item
    {
        ...
        public bool Primal { get; private set; }
        public bool Beta { get; private set; }
        public bool Ranger { get; private set; }
        public bool TierRitual { get; private set; }
        ...
        public bool Soulbound = false;//{ get; private set; }
        ...
        public Item(ushort type, XElement elem)
        {
            ...
            Primal = elem.Element("Primal") != null;
            Beta = elem.Element("Beta") != null;
            Ranger = elem.Element("Ranger") != null;
            TierRitual = elem.Element("TierRitual") != null;
    ...
    public class EquipmentSetDesc //for multi item skin
    {
        public ushort Type { get; private set; }
        public string Id { get; private set; }

        public ActivateEffect[] ActivateOnEquipAll { get; private set; }
        public ActivateEffect[] EffectOnEquipAll { get; private set; }
    ...
    public class SkinDesc
    {
        ...
        public static SkinDesc FromElem(ushort type, XElement skinElem)
        {
            ...
            sd.Cost = cost != null ? int.Parse(cost.Value) : 250;
