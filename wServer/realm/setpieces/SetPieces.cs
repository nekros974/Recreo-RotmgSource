...
namespace wServer.realm.setpieces
{
    partial class SetPieces
    {
       ...
       //     SetPiece(new Road(), 2, 2, WmapTerrain.Mountains),
           // SetPiece(new Crystal(), 1, 1, WmapTerrain.Mountains),
            SetPiece(new BlackMarket(), 1, 1, WmapTerrain.Mountains),
             SetPiece(new Garfield(), 5, 10, WmapTerrain.MidPlains),
             SetPiece(new Brick(), 5, 10, WmapTerrain.MidPlains),
            SetPiece(new Crystal2(), 1, 1, WmapTerrain.Mountains),
            SetPiece(new Volcano(), 1, 1, WmapTerrain.Mountains),
            SetPiece(new BeachMaze(), 1, 1, WmapTerrain.ShoreSand),
