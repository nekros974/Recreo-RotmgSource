...
namespace wServer.realm
{
    public class ChatManager : IDisposable
    {
        ...
        public void Say(Player src, string text) // texts in chat
        {
            //String Rank = "0";
            //if (src.Rank == 100)
         //   {
          ...
          //  }
            ...
            else
            {
               ...
               if (src.Rank == 10) { 
                    String nameString = "[Bronze] " + src.Name;
                    var tp = new Text()
                    {
                   
                        Name = (src.Client.Account.Admin ? "@" : "") + nameString,
                        ObjectId = src.Id,
                        NumStars = src.Stars,
                        Admin = src.Admin,
                        BubbleTime = 5,
                    ...
                    String nameString = "[Special SnowFlake] " + src.Name;
                    var tp = new Text()
                    {
                ...
                {
                    String nameString = "[Silver] " + src.Name;
                    var tp = new Text()
                    {
                    ...
                    String nameString = "[Gold] " + src.Name;
                    var tp = new Text()
                    {
                ...
                {
                    String nameString = "[Platinum] " + src.Name;
                    var tp = new Text()
                    {
                ...
                {
                    String nameString = "[Diamond] " + src.Name;
                    var tp = new Text()
                    {
                ...
                {
                    String nameString = "[Onyx] " + src.Name;
                    var tp = new Text()
                    {
                    ...
                    String nameString = "[Eternal] " + src.Name;
                    var tp = new Text()
                    {
                ...
                else if (src.Rank == 100){
                    String nameString = "[Admin] " + src.Name;
                    var tp = new Text()
                    {
