    ...
    class Oryx
    {
        ...
        private readonly List<Tuple<string, ISetPiece>> _events = new List<Tuple<string, ISetPiece>>()
        {
         ...
         //   Tuple.Create("shtrs Defense System", (ISetPiece) new Avatar()),
            //Tuple.Create("Black Market Quest", (ISetPiece) new BlackMarket()),
        ...
        private static readonly Tuple<string, TauntData>[] CriticalEnemies = new Tuple<string, TauntData>[]
        {
            ...
            // Tuple.Create("Black Market Quest", new TauntData()
            //{
            //    Spawn = new string[] {
            //        "It seems a portal to the black market has been opened."
            //    }
            ...
            new Dictionary<WmapTerrain, Tuple<int, Tuple<string, double>[]>>()
        {
            { WmapTerrain.ShoreSand, Tuple.Create(
               ...
               //     Tuple.Create("Mysterious Sand Castle", 0.005),
                })
            },
            { WmapTerrain.ShorePlains, Tuple.Create(
                600, new []//150
                {
                     Tuple.Create("Low Ghost God", 0.1),
                    Tuple.Create("Low Medusa", 0.1),
                    Tuple.Create("Bandit Leader", 0.2),
            ...
            { WmapTerrain.LowPlains, Tuple.Create(
                500, new []//200
                {
                       Tuple.Create("Low Ghost God", 0.1),
                    Tuple.Create("Low Medusa", 0.1),
                    Tuple.Create("Hobbit Mage", 0.3),
                    Tuple.Create("Undead Hobbit Mage", 0.3),
            ...
            { WmapTerrain.LowForest, Tuple.Create(
               500, new []//200
                {
                    Tuple.Create("Low Ent God", 0.05),
                    Tuple.Create("Vegetation Trap", 0.05),
                    Tuple.Create("Low Slime God", 0.11),
                    Tuple.Create("Elf Wizard", 0.2),
                    Tuple.Create("Goblin Mage", 0.2),
                    Tuple.Create("Easily Enraged Bunny", 0.2),
                    Tuple.Create("Forest Nymph", 0.2),
                })
            },
            { WmapTerrain.LowSand, Tuple.Create(
                500, new []//200
                {
                    Tuple.Create("Low Djinn", 0.3),
                    Tuple.Create("Low Beholder", 0.2),
                    Tuple.Create("Sandsman King", 0.1),
                    Tuple.Create("Giant Crab", 0.2),
                    Tuple.Create("Sand Devil", 0.1),
                })
            },
            { WmapTerrain.MidPlains, Tuple.Create(
                400, new []//150
                {
                    Tuple.Create("Low Ghost God", 0.1),
                    Tuple.Create("Low Medusa", 0.1),
                    Tuple.Create("Jester God", 0.1),
                    Tuple.Create("Fire Sprite", 0.05),
                    Tuple.Create("Ice Sprite", 0.05),
                    Tuple.Create("Magic Sprite", 0.05),
                    Tuple.Create("Pink Blob", 0.05),
                    Tuple.Create("Gray Blob", 0.05),
                    Tuple.Create("Earth Golem", 0.05),
                    Tuple.Create("Paper Golem", 0.05),
                    Tuple.Create("Big Green Slime", 0.05),
                    Tuple.Create("Swarm", 0.05),
                    Tuple.Create("Wasp Queen", 0.1),
                    Tuple.Create("Shambling Sludge", 0.05),
                    Tuple.Create("Orc King", 0.05),
            ...
            { WmapTerrain.MidForest, Tuple.Create(
                400, new []//150
                {
                    Tuple.Create("Low Ent God", 0.15),
                    Tuple.Create("Vegetation Trap", 0.15),
                    Tuple.Create("Low Slime God", 0.15),
                    Tuple.Create("Dwarf King", 0.1),
                    Tuple.Create("Metal Golem", 0.05),
                    Tuple.Create("Clockwork Golem", 0.05),
                    Tuple.Create("Werelion", 0.1),
                    Tuple.Create("Horned Drake", 0.2),
                    Tuple.Create("Red Spider", 0.05),
                    Tuple.Create("Black Bat", 0.05)
                })
            },
            { WmapTerrain.MidSand, Tuple.Create(
                600, new []//300
                {
                    Tuple.Create("Low Djinn", 0.15),
                    Tuple.Create("Pale Necromancer", 0.15),
                    Tuple.Create("Desert Assassin", 0.1),
                    Tuple.Create("Desert Werewolf", 0.1),
                    Tuple.Create("Fire Golem", 0.1),
                    Tuple.Create("Darkness Golem", 0.1),
                    Tuple.Create("Sand Phantom", 0.1),
                    Tuple.Create("Nomadic Shaman", 0.1),
            ...
            { WmapTerrain.HighPlains, Tuple.Create(
                ...
                {
                    Tuple.Create("Low Ghost God", 0.1),
                    Tuple.Create("Low Medusa", 0.2),
                    Tuple.Create("Jester God", 0.2),
                    Tuple.Create("Shield Orc Key", 0.1),
                    Tuple.Create("Urgle", 0.3),
                    Tuple.Create("Undead Dwarf God", 0.1)
                })
            },
            { WmapTerrain.HighForest, Tuple.Create(
                600, new []//300
                {
                    Tuple.Create("Low Ent God", 0.3),
                    Tuple.Create("Low Slime God", 0.3),
                    Tuple.Create("Vegetation Trap", 0.3),
                    Tuple.Create("Ogre King", 0.04),
                    Tuple.Create("Dragon Egg", 0.01),
                    Tuple.Create("Lizard God", 0.05),
                    Tuple.Create("Beer God", 0.01)
                })
            },
            { WmapTerrain.HighSand, Tuple.Create(
                600, new []//250
                {
                    Tuple.Create("Low Djinn", 0.2),
                    Tuple.Create("Pale Necromancer", 0.2),
                    Tuple.Create("Desert Assassin", 0.1),
                    Tuple.Create("Minotaur", 0.02),
                    Tuple.Create("Flayer God", 0.02),
                    Tuple.Create("Flamer King", 0.01)
                })
            },
            { WmapTerrain.Mountains, Tuple.Create(
                150, new []//100
                {
                    ...
                    Tuple.Create("Flying Brain", 0.096),
                    Tuple.Create("Slime God", 0.05),
                    Tuple.Create("Ghost God", 0.05),
                    Tuple.Create("Rock Bot", 0.05),
                    Tuple.Create("Djinn", 0.05),
                    Tuple.Create("Leviathan", 0.05),
                    Tuple.Create("Flame Guard", 0.05),
                    Tuple.Create("Spirit Guard", 0.05),
                    Tuple.Create("Factory Drone", 0.05),
        ...
        {
            Closing = true;
            _world.Manager.Chat.Announce("Realm closing in 1 minute. (WARNING: Server may experience a spike in lag when the realm closes.)", true);
        ...
        private void SendToCastle()
        {
            ...
            var castle = _world.Manager.AddWorld(
                new worlds.logic.Castle(_world.Manager.Resources.Worlds.Data["Wine Cellar"], playersEntering: _world.Players.Count));
