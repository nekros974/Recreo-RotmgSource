...
namespace wServer.realm.entities
{
    class Summon : StaticObject
    {
        ...
        int duration;
        public Summon(Player player, float radius, int dmg, ConditionEffectIndex eff, float effDuration)
            : base(player.Manager, 0x79e8, LIFETIME * 1000, true, true, false)
        {
            this.player = player;
            this.radius = radius;
            this.dmg = dmg;
