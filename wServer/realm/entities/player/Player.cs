...
namespace wServer.realm.entities
{
    ...
    public partial class Player : Character, IContainer, IPlayer
    {
        ...
        private readonly SV<int> _eventPoints;
        public int EventPoints
        {
            get { return _eventPoints.GetValue(); }
            set { _eventPoints.SetValue(value); }
        }
            ...
            : base(client.Manager, client.Character.ObjectType)
        {
            ...
            _eventPoints = new SV<int>(this, StatsType.EventPoints, client.Account.EventPoints, true);
