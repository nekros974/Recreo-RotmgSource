...
namespace wServer.realm.entities
{
    public partial class Player
    {
            ...
            new Dictionary<string, Tuple<int, int, int>>()  //Priority, Min, Max
        {
           ...
           // { "Mysterious Sand Castle",         Tuple.Create(13,15, 20) },
        //    { "Mysterious Crystal",             Tuple.Create(13,15, 20) },
            ...
            { "Gas Station Attendant",          Tuple.Create(14,15, 20) },
            { "Dragon Head",                    Tuple.Create(14,15, 20) },
            { "Lucky Ent God",                  Tuple.Create(14,15, 20) },
            { "Lucky Djinn",                    Tuple.Create(14,15, 20) },
            { "Onyx Guardian",                  Tuple.Create(14,15, 20) },
            { "Cthulhu",                        Tuple.Create(14,15, 20) },
            { "Brick",                          Tuple.Create(14,15, 20) },
          ...
          //  { "Oryx Stone Guardian Right",      Tuple.Create(15,1, 20) },
            ...
            { "Shark God",                      Tuple.Create(15,1, 20) },
            { "Goblin King",                    Tuple.Create(15,1, 20) },
            { "Dwarven Construct",              Tuple.Create(15,1, 20) },
            { "Cameron the Bone God",           Tuple.Create(15,1, 20) },
            { "Corn God",                       Tuple.Create(15,1, 20) },
            { "Incinerator",                    Tuple.Create(15,1, 20) },
            { "Project UNKNOWN",                Tuple.Create(15,1, 20) },
            { "Banshee Queen",                  Tuple.Create(15,1, 20) },
            { "Urgle King",                     Tuple.Create(15,1, 20) },
            { "Magic God",                      Tuple.Create(15,1, 20) },
