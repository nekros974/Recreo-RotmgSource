...
namespace wServer.realm.worlds.logic
{
    public class Realm : World
    {
        ...
        protected override void Init()
        {
         ...
         //   FromWorldMap(new MemoryStream(Json2Wmap.Convert(Manager.Resources.GameData, )));
        ...
        public override void Tick(RealmTime time)
        {
            ...
            if (_overseerTask == null || _overseerTask.IsCompleted)
            {
                ...
                {
                    var secondsElapsed = time.TotalElapsedMs/1000;//putting the 1000 to a ten changed it to like maybe 5 minutes?
