...
namespace wServer.realm.commands
{
    ...
    {
        public TutorialCommand() : base("new") { }
    ...
    class VaultCommand2 : Command
    {
        public VaultCommand2() : base("v") { }
    ...
    class TeleportCommand : Command
    {
        ...
        protected override bool Process(Player player, RealmTime time, string args)
        {
            ...
            {
                player.SendError($"You Cannot Teleport in Nexus.");
                return false;
            }
    }
    }
  ...
  /*  class NpeCommand : Command
    ...
    */
    ...
    class ToRealmCommand : Command
    {
        public ToRealmCommand() : base("ToRealm", alias: "r") { }
        ...
        protected override bool Process(Player player, RealmTime time, string args)
        {
            ...
            player.TeleportPosition(time, 124, 122);
            return true;
        }
    }
    class ShowPointCommand : Command
    {
        public ShowPointCommand() : base("showeventpoints", alias: "showEP") { }
        ...
        protected override bool Process(Player player, RealmTime time, string args)
        {
            // var amount2 = int.Parse(args);
                ...
                player.SendInfo("You have " + player.Client.Account.EventPoints+" Event Points!");
              //  return false;
           // }
    ...
    class ToSpawnCommand : Command
    {
        public ToSpawnCommand() : base("ToSpawn", alias: "s") { }
        ...
        protected override bool Process(Player player, RealmTime time, string args)
        {
            ...
            player.TeleportPosition(time, 124, 144);
            return true;
        }
    }
