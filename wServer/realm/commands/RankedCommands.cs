...
namespace wServer.realm.commands
{
    ...
    class SetFameCommand : Command
    {
        ...
        protected override bool Process(Player player, RealmTime time, string args)
        {
            ...
            if (string.IsNullOrEmpty(args))
            {
                player.SendInfo("/fame <amount>");
                return false;
            }
            player.Fame = player.Client.Account.Fame += amount2;
            player.ForceUpdate(player.Fame);
            return true;
        }
    }
    class SetEventPointsCommand : Command
    {
        public SetEventPointsCommand() : base("setEventPoints", permLevel: 90, alias: "eventpoints") { }
        ...
        protected override bool Process(Player player, RealmTime time, string args)
        {
            ...
            if (string.IsNullOrEmpty(args))
            {
                player.SendInfo("/eventPoints <amount>");
                return false;
            }
            player.EventPoints = player.Client.Account.EventPoints += amount2;
            player.ForceUpdate(player.EventPoints);
            return true;
        }
    }
    ...
    class DZoneOneCommand : Command
    {
        public DZoneOneCommand() : base("DonaterZone", permLevel: 10, alias: "dz") { }

        protected override bool Process(Player player, RealmTime time, string args)
        {
            if (!(player.Owner is Nexus))
            {
                player.SendError("This command requires you to be in nexus first.");
                return false;
            }

            player.TeleportPosition(time, 85 + 0.5f, 31 + 0.5f);
            return true;
        }
    }

    class DZoneTwoCommand : Command
    {
        public DZoneTwoCommand() : base("SuperZone", permLevel: 30, alias: "sz") { }
        ...
        protected override bool Process(Player player, RealmTime time, string args)
        {
            ...
            player.TeleportPosition(time, 126 + 0.5f, 31 + 0.5f);
            return true;
        }
    }

    class DZoneThreeCommand : Command
    {
        public DZoneThreeCommand() : base("UltraZone", permLevel: 50, alias: "uz") { }
        ...
        protected override bool Process(Player player, RealmTime time, string args)
        {
            ...
            player.TeleportPosition(time, 167 + 0.5f, 31 + 0.5f);
            return true;
        }
    }
    ...
    //{
    //    public godCommand() : base("god", permLevel: 80, alias: "g") { }
    ...
    {
        public GlowCommand() : base("glow", permLevel: 30) { }
